...
public class PNMLTransformerTest extends XMLTestCase
{
    ...
    static {
        final StringBuilder simpleNetFileBuilder = new StringBuilder();
        simpleNetFileBuilder.append("src")
                            .append(SLASH)
                            .append("test")
                            .append(SLASH)
                            .append("resources")
...
//	@Test  Junit 3 will be used to run this class because it uses XMLUnit; @Test annotations ignored.
	...
	{
		return new StreamSource(new ByteArrayInputStream(net.getBytes()));
	}
